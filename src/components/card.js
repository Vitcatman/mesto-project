...
export default class Card {
  constructor(cardData, user, selector, { deleteButtonHandler, putLike, deleteLike, zoomPicture}) {
    this._user = user;
  ...
  _setEventListeners() {
    ...
    this._cardImage.addEventListener("click", () => this._zoomPicture(this._link, this._name));
  }
